...
class PartitionBackupConfigurationInfo(BackupConfigurationInfo):
    ...
    def __init__(self, policy_name=None, policy_inherited_from=None, suspension_info=None, service_name=None, partition_id=None):
        super(PartitionBackupConfigurationInfo, self).__init__(policy_name=policy_name, policy_inherited_from=policy_inherited_from, suspension_info=suspension_info)
