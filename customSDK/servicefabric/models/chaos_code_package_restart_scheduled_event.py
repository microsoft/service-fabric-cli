...
class ChaosCodePackageRestartScheduledEvent(ApplicationEvent):
    ...
    def __init__(self, event_instance_id, time_stamp, application_id, fault_group_id, fault_id, node_name, service_manifest_name, code_package_name, service_package_activation_id, category=None, has_correlated_events=None):
        super(ChaosCodePackageRestartScheduledEvent, self).__init__(event_instance_id=event_instance_id, category=category, time_stamp=time_stamp, has_correlated_events=has_correlated_events, application_id=application_id)
