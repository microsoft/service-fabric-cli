...
class GetBackupByStorageQueryDescription(Model):
    ...
    :param start_date_time_filter: Specifies the start date time in UTC from
     which to enumerate backups. If not specified, backups are enumerated from
     the beginning.
    :type start_date_time_filter: datetime
    :param end_date_time_filter: Specifies the end date time in UTC till which
     to enumerate backups. If not specified, backups are enumerated till the
     end.
