...
class DeployedServiceHealthReportExpiredEvent(ApplicationEvent):
    ...
    def __init__(self, event_instance_id, time_stamp, application_id, service_manifest, service_package_instance_id, service_package_activation_id, node_name, source_id, property, health_state, ttl_timespan, sequence_number, description, remove_when_expired, source_utc_timestamp, has_correlated_events=None):
        super(DeployedServiceHealthReportExpiredEvent, self).__init__(event_instance_id=event_instance_id, time_stamp=time_stamp, has_correlated_events=has_correlated_events, application_id=application_id)
