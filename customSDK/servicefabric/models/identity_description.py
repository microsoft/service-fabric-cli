...
class IdentityDescription(Model):
    """Information describing the identites associated with this application.

    :param token_service_endpoint: the endpoint for the token service managing
     this identity
    :type token_service_endpoint: str
    :param type: the types of identities associated with this resource;
    ...
    def __init__(self, type, token_service_endpoint=None, tenant_id=None, principal_id=None, user_assigned_identities=None):
        super(IdentityDescription, self).__init__()
