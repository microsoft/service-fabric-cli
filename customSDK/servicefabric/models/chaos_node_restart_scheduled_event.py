...
class ChaosNodeRestartScheduledEvent(NodeEvent):
    ...
    def __init__(self, event_instance_id, time_stamp, node_name, node_instance_id, fault_group_id, fault_id, category=None, has_correlated_events=None):
        super(ChaosNodeRestartScheduledEvent, self).__init__(event_instance_id=event_instance_id, category=category, time_stamp=time_stamp, has_correlated_events=has_correlated_events, node_name=node_name)
