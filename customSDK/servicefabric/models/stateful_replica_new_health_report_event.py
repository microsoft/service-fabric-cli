...
class StatefulReplicaNewHealthReportEvent(ReplicaEvent):
    ...
    def __init__(self, event_instance_id, time_stamp, partition_id, replica_id, replica_instance_id, source_id, property, health_state, time_to_live_ms, sequence_number, description, remove_when_expired, source_utc_timestamp, category=None, has_correlated_events=None):
        super(StatefulReplicaNewHealthReportEvent, self).__init__(event_instance_id=event_instance_id, category=category, time_stamp=time_stamp, has_correlated_events=has_correlated_events, partition_id=partition_id, replica_id=replica_id)
