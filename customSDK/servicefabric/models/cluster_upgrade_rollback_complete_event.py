...
class ClusterUpgradeRollbackCompleteEvent(ClusterEvent):
    ...
    :param failure_reason: Describes failure.
    :type failure_reason: str
    :param overall_upgrade_elapsed_time_in_ms: Overall duration of upgrade in
     milli-seconds.
    ...
    def __init__(self, event_instance_id, time_stamp, target_cluster_version, failure_reason, overall_upgrade_elapsed_time_in_ms, has_correlated_events=None):
        super(ClusterUpgradeRollbackCompleteEvent, self).__init__(event_instance_id=event_instance_id, time_stamp=time_stamp, has_correlated_events=has_correlated_events)
        ...
        self.kind = 'ClusterUpgradeRollbackComplete'
