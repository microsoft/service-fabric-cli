...
class ApplicationUpgradeDescription(Model):
    ...
    def __init__(self, name, target_application_type_version, parameters=None, upgrade_kind="Rolling", rolling_upgrade_mode="UnmonitoredAuto", upgrade_replica_set_check_timeout_in_seconds=None, force_restart=None, sort_order="Default", monitoring_policy=None, application_health_policy=None):
