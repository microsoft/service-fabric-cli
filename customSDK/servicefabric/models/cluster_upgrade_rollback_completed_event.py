...
class ClusterUpgradeRollbackCompletedEvent(ClusterEvent):
    ...
    def __init__(self, event_instance_id, time_stamp, target_cluster_version, failure_reason, overall_upgrade_elapsed_time_in_ms, category=None, has_correlated_events=None):
        super(ClusterUpgradeRollbackCompletedEvent, self).__init__(event_instance_id=event_instance_id, category=category, time_stamp=time_stamp, has_correlated_events=has_correlated_events)
