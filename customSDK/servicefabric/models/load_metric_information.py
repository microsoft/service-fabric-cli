...
class LoadMetricInformation(Model):
    ...
    def __init__(self, name=None, is_balanced_before=None, is_balanced_after=None, deviation_before=None, deviation_after=None, balancing_threshold=None, action=None, activity_threshold=None, cluster_capacity=None, cluster_load=None, current_cluster_load=None, cluster_remaining_capacity=None, cluster_capacity_remaining=None, is_cluster_capacity_violation=None, node_buffer_percentage=None, cluster_buffered_capacity=None, buffered_cluster_capacity_remaining=None, cluster_remaining_buffered_capacity=None, min_node_load_value=None, minimum_node_load=None, min_node_load_node_id=None, max_node_load_value=None, maximum_node_load=None, max_node_load_node_id=None, planned_load_removal=None):
        super(LoadMetricInformation, self).__init__()
        self.name = name
