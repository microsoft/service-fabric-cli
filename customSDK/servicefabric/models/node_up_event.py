...
class NodeUpEvent(NodeEvent):
    ...
    :param last_node_down_at: Last Node Down At
    ...
    def __init__(self, event_instance_id, time_stamp, node_name, node_instance, last_node_down_at, has_correlated_events=None):
        super(NodeUpEvent, self).__init__(event_instance_id=event_instance_id, time_stamp=time_stamp, has_correlated_events=has_correlated_events, node_name=node_name)
