...
class ApplicationUpgradeRollbackCompleteEvent(ApplicationEvent):
    ...
    def __init__(self, event_instance_id, time_stamp, application_id, application_type_name, application_type_version, failure_reason, overall_upgrade_elapsed_time_in_ms, has_correlated_events=None):
        super(ApplicationUpgradeRollbackCompleteEvent, self).__init__(event_instance_id=event_instance_id, time_stamp=time_stamp, has_correlated_events=has_correlated_events, application_id=application_id)
        ...
        self.kind = 'ApplicationUpgradeRollbackComplete'
