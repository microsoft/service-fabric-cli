...
class DeployedServicePackageHealthReportExpiredEvent(ApplicationEvent):
    ...
    :param service_manifest: Service manifest name.
    :type service_manifest: str
    :param service_package_instance_id: Id of Service package instance.
    ...
    def __init__(self, event_instance_id, time_stamp, application_id, service_manifest, service_package_instance_id, service_package_activation_id, node_name, source_id, property, health_state, time_to_live_ms, sequence_number, description, remove_when_expired, source_utc_timestamp, category=None, has_correlated_events=None):
        super(DeployedServicePackageHealthReportExpiredEvent, self).__init__(event_instance_id=event_instance_id, category=category, time_stamp=time_stamp, has_correlated_events=has_correlated_events, application_id=application_id)
