...
class ClusterHealthReportCreatedEvent(ClusterEvent):
    ...
    def __init__(self, event_instance_id, time_stamp, source_id, property, health_state, time_to_live_ms, sequence_number, description, remove_when_expired, source_utc_timestamp, has_correlated_events=None):
        super(ClusterHealthReportCreatedEvent, self).__init__(event_instance_id=event_instance_id, time_stamp=time_stamp, has_correlated_events=has_correlated_events)
