...
class ChaosPartitionPrimaryMoveScheduledEvent(PartitionEvent):
    ...
    def __init__(self, event_instance_id, time_stamp, partition_id, fault_group_id, fault_id, service_name, node_to, forced_move, category=None, has_correlated_events=None):
        super(ChaosPartitionPrimaryMoveScheduledEvent, self).__init__(event_instance_id=event_instance_id, category=category, time_stamp=time_stamp, has_correlated_events=has_correlated_events, partition_id=partition_id)
