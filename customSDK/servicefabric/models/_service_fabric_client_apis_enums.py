...
class ApplicationDefinitionKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ApplicationPackageCleanupPolicy(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ApplicationResourceUpgradeState(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ApplicationScopedVolumeKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ApplicationStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ApplicationTypeDefinitionKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ApplicationTypeStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AutoScalingMechanismKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AutoScalingMetricKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AutoScalingResourceMetricName(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AutoScalingTriggerKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class BackupEntityKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class BackupPolicyScope(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class BackupScheduleFrequencyType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class BackupScheduleKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class BackupState(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class BackupStorageKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class BackupSuspensionScope(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ChaosEventKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ChaosScheduleStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ChaosStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ComposeDeploymentStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ComposeDeploymentUpgradeState(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class CreateFabricDump(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class DataLossMode(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class DeactivationIntent(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class DeployedApplicationStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class DiagnosticsSinkKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class EntryPointStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ExecutionPolicyType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class FabricErrorCodes(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class FabricEventKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class FabricReplicaStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class FailureReason(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class HeaderMatchType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """how to match header value
    """

    EXACT = "exact"

class HealthEvaluationKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class HostIsolationMode(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class HostOptions(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ImageRegistryPasswordType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ImpactLevel(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class NetworkKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class NodeDeactivationIntent(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class NodeDeactivationStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class NodeDeactivationTaskType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class NodeStatusFilter(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class NodeTransitionType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class NodeUpgradePhase(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class OperationState(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class Ordering(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """Defines the order.
    """
...
class PackageSharingPolicyScope(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class PartitionAccessStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class PathMatchType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """how to match value in the Uri
    """

    PREFIX = "prefix"

class PropertyBatchInfoKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class PropertyBatchOperationKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class PropertyValueKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ProvisionApplicationTypeKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class QuorumLossMode(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ReconfigurationPhase(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ReconfigurationType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class RepairImpactKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class RepairTargetKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class RepairTaskHealthCheckState(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ReplicaHealthReportServiceKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ReplicaKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ReplicaRole(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """The role of a replica of a stateful service.
    """
    ...
    #: Refers to a replica in the set that receives a state transfer from the Primary replica to
    #: prepare for becoming an ActiveAuxiliary replica. There can be multiple IdleAuxiliary replicas
    #: in a replica set at a time. IdleAuxiliary replicas do not count as a part of a write quorum.
    #: The value is 5.
    IDLE_AUXILIARY = "IdleAuxiliary"
    #: Refers to a replica in the set that receives state updates from the Primary replica, applies
    #: them, and sends acknowledgements back. ActiveAuxiliary replicas must participate in the write
    #: quorum for a replica set. There can be multiple active ActiveAuxiliary replicas in a replica
    #: set at a time. The number of active ActiveAuxiliary replicas is configurable that the
    #: reliability subsystem should maintain. The value is 6.
    ACTIVE_AUXILIARY = "ActiveAuxiliary"
    #: Refers to the replica in the set that is used to rebuild a new Secondary replica to relinquish
    #: primary status to. It cannot field read or write requests. The value is 7.
    PRIMARY_AUXILIARY = "PrimaryAuxiliary"

class ReplicaStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ReplicatorOperationName(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class RestartPartitionMode(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class RestartPolicy(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class RestoreState(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ResultStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class RetentionPolicyType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class SafetyCheckKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ScalingMechanismKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ScalingTriggerKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """Enumerates the ways that a service can be scaled.
    """
...
class SecretKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ServiceEndpointRole(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ServiceHostUpgradeImpact(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """The expected impact of the upgrade.
    """

    #: Indicates the upgrade impact is invalid. All Service Fabric enumerations have the invalid type.
    #: The value is zero.
    INVALID = "Invalid"
    ...
    #: The upgrade will cause an unexpected service host restart. This indicates a bug in the Service
    #: Fabric runtime and proceeding with an upgrade with this impact may lead to skipped safety
    #: checks. Running the upgrade with the ForceRestart flag will force proper safety checks. The
    #: value is 3.
...
class ServiceOperationName(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ServicePartitionKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ServicePartitionStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ServiceTypeRegistrationStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class SizeTypes(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """Volume size
    """
...
class UpgradeDomainState(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class UpgradeKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class UpgradeMode(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    ...
    #: before proceeding. The value is 3.
    MONITORED = "Monitored"
    #: Perform a node-by-node upgrade. No action is performed when upgrade starts; upgrade is applied
    #: on each node when it is deactivated with intent restart or higher. The value is 4.
    UNMONITORED_DEFERRED = "UnmonitoredDeferred"

class UpgradeSortOrder(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class UpgradeType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class UpgradeUnitState(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """The state of the upgrade unit.
    """

    #: Indicates the upgrade unit state is invalid. All Service Fabric enumerations have the invalid
    #: type. The value is zero.
    INVALID = "Invalid"
...
class VolumeProvider(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
