...
class ChaosRemoveReplicaFaultScheduledEvent(ReplicaEvent):
    ...
    def __init__(self, event_instance_id, time_stamp, partition_id, replica_id, fault_group_id, fault_id, service_uri, has_correlated_events=None):
        super(ChaosRemoveReplicaFaultScheduledEvent, self).__init__(event_instance_id=event_instance_id, time_stamp=time_stamp, has_correlated_events=has_correlated_events, partition_id=partition_id, replica_id=replica_id)
