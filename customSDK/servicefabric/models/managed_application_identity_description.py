...
class ManagedApplicationIdentityDescription(Model):
    ...
    def __init__(self, token_service_endpoint=None, managed_identities=None):
        super(ManagedApplicationIdentityDescription, self).__init__()
