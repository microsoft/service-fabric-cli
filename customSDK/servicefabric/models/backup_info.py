...
class BackupInfo(Model):
    ...
    def __init__(self, backup_id=None, backup_chain_id=None, application_name=None, service_name=None, partition_information=None, backup_location=None, backup_type=None, epoch_of_last_backup_record=None, lsn_of_last_backup_record=None, creation_time_utc=None, service_manifest_version=None, failure_error=None):
