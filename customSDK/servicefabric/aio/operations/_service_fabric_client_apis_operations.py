...
class ServiceFabricClientAPIsOperationsMixin:  # pylint: disable=too-many-public-methods
    ...
    async def get_cluster_manifest(
        ...
        **kwargs: Any
        ...
        request = build_get_cluster_manifest_request(
            ...
            timeout=timeout,
            template_url=self.get_cluster_manifest.metadata['url'],
        )
    ...
    async def get_cluster_health(
        ...
        **kwargs: Any
        ...
        request = build_get_cluster_health_request(
            ...
            timeout=timeout,
            template_url=self.get_cluster_health.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_cluster_health_using_policy(
        ...
        include_system_application_health_statistics: Optional[bool] = False,
        timeout: Optional[int] = 60,
        application_health_policy_map: Optional[List["_models.ApplicationHealthPolicyMapItem"]] = None,
        cluster_health_policy: Optional["_models.ClusterHealthPolicy"] = None,
        **kwargs: Any
    ) -> "_models.ClusterHealth":
        ...
        :param application_health_policy_map: Defines a map that contains specific application health
         ...
         The map is empty by default. Default value is None.
        ...
        :param cluster_health_policy: Defines a health policy used to evaluate the health of the
         cluster or of a cluster node. Default value is None.
        ...
        if _cluster_health_policies is not None:
            _json = self._serialize.body(_cluster_health_policies, 'ClusterHealthPolicies')
        else:
            _json = None
        ...
        request = build_get_cluster_health_using_policy_request(
            ...
            include_system_application_health_statistics=include_system_application_health_statistics,
            timeout=timeout,
            template_url=self.get_cluster_health_using_policy.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_cluster_health_chunk(
        ...
        **kwargs: Any
        ...
        request = build_get_cluster_health_chunk_request(
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_cluster_health_chunk.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_cluster_health_chunk_using_policy_and_advanced_filters(
        self,
        timeout: Optional[int] = 60,
        cluster_health_chunk_query_description: Optional["_models.ClusterHealthChunkQueryDescription"] = None,
        **kwargs: Any
    ) -> "_models.ClusterHealthChunk":
        """Gets the health of a Service Fabric cluster using health chunks.
        ...
        if cluster_health_chunk_query_description is not None:
            _json = self._serialize.body(cluster_health_chunk_query_description, 'ClusterHealthChunkQueryDescription')
        else:
            _json = None
        ...
        request = build_get_cluster_health_chunk_using_policy_and_advanced_filters_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.get_cluster_health_chunk_using_policy_and_advanced_filters.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def report_cluster_health(  # pylint: disable=inconsistent-return-statements
        self,
        health_information: "_models.HealthInformation",
        ...
        **kwargs: Any
        ...
        request = build_report_cluster_health_request(
            ...
            immediate=immediate,
            timeout=timeout,
            template_url=self.report_cluster_health.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_provisioned_fabric_code_version_info_list(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> List["_models.FabricCodeVersionInfo"]:
        ...
        :param code_version: The product version of Service Fabric. Default value is None.
        ...
        request = build_get_provisioned_fabric_code_version_info_list_request(
            ...
            timeout=timeout,
            template_url=self.get_provisioned_fabric_code_version_info_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_provisioned_fabric_config_version_info_list(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> List["_models.FabricConfigVersionInfo"]:
        ...
        request = build_get_provisioned_fabric_config_version_info_list_request(
            ...
            timeout=timeout,
            template_url=self.get_provisioned_fabric_config_version_info_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_cluster_upgrade_progress(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.ClusterUpgradeProgressObject":
        ...
        request = build_get_cluster_upgrade_progress_request(
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_cluster_upgrade_progress.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_cluster_configuration(
        ...
        **kwargs: Any
        ...
        request = build_get_cluster_configuration_request(
            ...
            timeout=timeout,
            template_url=self.get_cluster_configuration.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_cluster_configuration_upgrade_status(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.ClusterConfigurationUpgradeStatusInfo":
        ...
        request = build_get_cluster_configuration_upgrade_status_request(
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_cluster_configuration_upgrade_status.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_upgrade_orchestration_service_state(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.UpgradeOrchestrationServiceState":
        ...
        request = build_get_upgrade_orchestration_service_state_request(
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_upgrade_orchestration_service_state.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def set_upgrade_orchestration_service_state(
        ...
        **kwargs: Any
    ) -> "_models.UpgradeOrchestrationServiceStateSummary":
        ...
        :param timeout: The server timeout for performing the operation in seconds. This timeout
         ...
         complete. The default value for this parameter is 60 seconds. Default value is 60.
        :type timeout: long
        :param service_state: The state of Service Fabric Upgrade Orchestration Service. Default value
         is None.
        ...
        _json = self._serialize.body(_upgrade_orchestration_service_state, 'UpgradeOrchestrationServiceState')
        ...
        request = build_set_upgrade_orchestration_service_state_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.set_upgrade_orchestration_service_state.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def provision_cluster(  # pylint: disable=inconsistent-return-statements
        ...
        cluster_manifest_file_path: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        ...
        :param timeout: The server timeout for performing the operation in seconds. This timeout
         ...
         complete. The default value for this parameter is 60 seconds. Default value is 60.
        :type timeout: long
        :param code_file_path: The cluster code package file path. Default value is None.
        :type code_file_path: str
        :param cluster_manifest_file_path: The cluster manifest file path. Default value is None.
        ...
        _json = self._serialize.body(_provision_fabric_description, 'ProvisionFabricDescription')
        ...
        request = build_provision_cluster_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.provision_cluster.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def unprovision_cluster(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param timeout: The server timeout for performing the operation in seconds. This timeout
         ...
         complete. The default value for this parameter is 60 seconds. Default value is 60.
        :type timeout: long
        :param code_version: The cluster code package version. Default value is None.
        :type code_version: str
        :param config_version: The cluster manifest version. Default value is None.
        :type config_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        ...
        _json = self._serialize.body(_unprovision_fabric_description, 'UnprovisionFabricDescription')
        ...
        request = build_unprovision_cluster_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.unprovision_cluster.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def rollback_cluster_upgrade(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_rollback_cluster_upgrade_request(
            api_version=api_version,
            timeout=timeout,
            template_url=self.rollback_cluster_upgrade.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def resume_cluster_upgrade(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        _json = self._serialize.body(_resume_cluster_upgrade_description, 'ResumeClusterUpgradeDescription')
        ...
        request = build_resume_cluster_upgrade_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.resume_cluster_upgrade.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def start_cluster_upgrade(  # pylint: disable=inconsistent-return-statements
        self,
        start_cluster_upgrade_description: "_models.StartClusterUpgradeDescription",
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> None:
        ...
        request = build_start_cluster_upgrade_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.start_cluster_upgrade.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def start_cluster_configuration_upgrade(  # pylint: disable=inconsistent-return-statements
        self,
        cluster_configuration_upgrade_description: "_models.ClusterConfigurationUpgradeDescription",
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> None:
        ...
        request = build_start_cluster_configuration_upgrade_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.start_cluster_configuration_upgrade.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def update_cluster_upgrade(  # pylint: disable=inconsistent-return-statements
        self,
        update_cluster_upgrade_description: "_models.UpdateClusterUpgradeDescription",
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> None:
        ...
        request = build_update_cluster_upgrade_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.update_cluster_upgrade.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_aad_metadata(
        ...
        **kwargs: Any
        ...
        request = build_get_aad_metadata_request(
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_aad_metadata.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_cluster_version(
        ...
        **kwargs: Any
        ...
        request = build_get_cluster_version_request(
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_cluster_version.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_cluster_load(
        ...
        **kwargs: Any
        ...
        request = build_get_cluster_load_request(
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_cluster_load.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def toggle_verbose_service_placement_health_reporting(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_toggle_verbose_service_placement_health_reporting_request(
            ...
            enabled=enabled,
            timeout=timeout,
            template_url=self.toggle_verbose_service_placement_health_reporting.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def validate_cluster_upgrade(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.ValidateClusterUpgradeResult":
        ...
        :type timeout: long
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ValidateClusterUpgradeResult, or the result of cls(response)
        :rtype: ~azure.servicefabric.models.ValidateClusterUpgradeResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ValidateClusterUpgradeResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        request = build_validate_cluster_upgrade_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.validate_cluster_upgrade.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        ...
        deserialized = self._deserialize('ValidateClusterUpgradeResult', pipeline_response)
    ...
    validate_cluster_upgrade.metadata = {'url': "/$/ValidateUpgrade"}  # type: ignore
    ...
    async def get_node_info_list(
        ...
        node_status_filter: Optional[Union[str, "_models.NodeStatusFilter"]] = "default",
        max_results: Optional[int] = 0,
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.PagedNodeInfoList":
        ...
        :param node_status_filter: Allows filtering the nodes based on the NodeStatus. Only the nodes
         ...
         the following. Default value is "default".
        ...
        request = build_get_node_info_list_request(
            ...
            timeout=timeout,
            template_url=self.get_node_info_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_node_info(
        ...
        **kwargs: Any
        ...
        request = build_get_node_info_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_node_info.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_node_health(
        ...
        **kwargs: Any
        ...
        request = build_get_node_health_request(
            ...
            events_health_state_filter=events_health_state_filter,
            timeout=timeout,
            template_url=self.get_node_health.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_node_health_using_policy(
        ...
        **kwargs: Any
        ...
        if cluster_health_policy is not None:
            _json = self._serialize.body(cluster_health_policy, 'ClusterHealthPolicy')
        else:
            _json = None
        ...
        request = build_get_node_health_using_policy_request(
            ...
            events_health_state_filter=events_health_state_filter,
            timeout=timeout,
            template_url=self.get_node_health_using_policy.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def report_node_health(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_report_node_health_request(
            ...
            immediate=immediate,
            timeout=timeout,
            template_url=self.report_node_health.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_node_load_info(
        ...
        **kwargs: Any
        ...
        request = build_get_node_load_info_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_node_load_info.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def disable_node(  # pylint: disable=inconsistent-return-statements
        ...
        node_name: str,
        timeout: Optional[int] = 60,
        deactivation_intent: Optional[Union[str, "_models.DeactivationIntent"]] = None,
        **kwargs: Any
    ) -> None:
        ...
        :param deactivation_intent: Describes the intent or reason for deactivating the node. The
         possible values are following. Default value is None.
        ...
        request = build_disable_node_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.disable_node.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def enable_node(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_enable_node_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.enable_node.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def remove_node_state(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_remove_node_state_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.remove_node_state.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def restart_node(  # pylint: disable=inconsistent-return-statements
        ...
        create_fabric_dump: Optional[Union[str, "_models.CreateFabricDump"]] = "False",
        **kwargs: Any
    ) -> None:
        ...
        :param node_instance_id: The instance ID of the target node. If instance ID is specified the
         ...
         "0" would match any instance ID. The instance ID can be obtained using get node query. Default
         value is "0".
        ...
        _json = self._serialize.body(_restart_node_description, 'RestartNodeDescription')
        ...
        request = build_restart_node_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.restart_node.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def remove_configuration_overrides(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_remove_configuration_overrides_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.remove_configuration_overrides.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_configuration_overrides(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> List["_models.ConfigParameterOverride"]:
        ...
        request = build_get_configuration_overrides_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_configuration_overrides.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def add_configuration_parameter_overrides(  # pylint: disable=inconsistent-return-statements
        self,
        node_name: str,
        config_parameter_override_list: List["_models.ConfigParameterOverride"],
        ...
        **kwargs: Any
        ...
        request = build_add_configuration_parameter_overrides_request(
            ...
            force=force,
            timeout=timeout,
            template_url=self.add_configuration_parameter_overrides.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def remove_node_tags(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_remove_node_tags_request(
            ...
            content_type=content_type,
            json=_json,
            template_url=self.remove_node_tags.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def add_node_tags(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_add_node_tags_request(
            ...
            content_type=content_type,
            json=_json,
            template_url=self.add_node_tags.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_application_type_info_list(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.PagedApplicationTypeInfoList":
        ...
        request = build_get_application_type_info_list_request(
            ...
            max_results=max_results,
            timeout=timeout,
            template_url=self.get_application_type_info_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_application_type_info_list_by_name(
        ...
        **kwargs: Any
        ...
        request = build_get_application_type_info_list_by_name_request(
            ...
            max_results=max_results,
            timeout=timeout,
            template_url=self.get_application_type_info_list_by_name.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def provision_application_type(  # pylint: disable=inconsistent-return-statements
        self,
        provision_application_type_description_base_required_body_param: "_models.ProvisionApplicationTypeDescriptionBase",
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> None:
        ...
        request = build_provision_application_type_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.provision_application_type.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def unprovision_application_type(  # pylint: disable=inconsistent-return-statements
        ...
        timeout: Optional[int] = 60,
        async_parameter: Optional[bool] = None,
        **kwargs: Any
    ) -> None:
        ...
        _json = self._serialize.body(_unprovision_application_type_description_info, 'UnprovisionApplicationTypeDescriptionInfo')
        ...
        request = build_unprovision_application_type_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.unprovision_application_type.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def update_application_type_arm_metadata(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param timeout: The server timeout for performing the operation in seconds. This timeout
         ...
         complete. The default value for this parameter is 60 seconds. Default value is 60.
        :type timeout: long
        :param force: Force parameter used to prevent accidental Arm metadata update. Default value is
         None.
        :type force: bool
        :param arm_resource_id: A string containing the ArmResourceId. Default value is None.
        ...
        _json = self._serialize.body(_application_type_arm_metadata_update_description, 'ArmMetadata')
        ...
        request = build_update_application_type_arm_metadata_request(
            ...
            timeout=timeout,
            force=force,
            template_url=self.update_application_type_arm_metadata.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    update_application_type_arm_metadata.metadata = {'url': "/ApplicationTypes/{applicationTypeName}/$/UpdateArmMetadata"}  # type: ignore
    ...
    async def get_service_type_info_list(
        ...
        **kwargs: Any
        ...
        request = build_get_service_type_info_list_request(
            ...
            application_type_version=application_type_version,
            timeout=timeout,
            template_url=self.get_service_type_info_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_service_type_info_by_name(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> Optional["_models.ServiceTypeInfo"]:
        ...
        request = build_get_service_type_info_by_name_request(
            ...
            application_type_version=application_type_version,
            timeout=timeout,
            template_url=self.get_service_type_info_by_name.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_service_manifest(
        ...
        **kwargs: Any
        ...
        request = build_get_service_manifest_request(
            ...
            timeout=timeout,
            template_url=self.get_service_manifest.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_deployed_service_type_info_list(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> List["_models.DeployedServiceTypeInfo"]:
        ...
        request = build_get_deployed_service_type_info_list_request(
            ...
            service_manifest_name=service_manifest_name,
            timeout=timeout,
            template_url=self.get_deployed_service_type_info_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_deployed_service_type_info_by_name(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> Optional[List["_models.DeployedServiceTypeInfo"]]:
        ...
        request = build_get_deployed_service_type_info_by_name_request(
            ...
            service_manifest_name=service_manifest_name,
            timeout=timeout,
            template_url=self.get_deployed_service_type_info_by_name.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def create_application(  # pylint: disable=inconsistent-return-statements
        self,
        application_description: "_models.ApplicationDescription",
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> None:
        ...
        request = build_create_application_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.create_application.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def delete_application(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_delete_application_request(
            ...
            timeout=timeout,
            template_url=self.delete_application.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_application_load_info(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> Optional["_models.ApplicationLoadInfo"]:
        ...
        request = build_get_application_load_info_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_application_load_info.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_application_info_list(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.PagedApplicationInfoList":
        ...
        request = build_get_application_info_list_request(
            ...
            max_results=max_results,
            timeout=timeout,
            template_url=self.get_application_info_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_application_info(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> Optional["_models.ApplicationInfo"]:
        ...
        request = build_get_application_info_request(
            ...
            exclude_application_parameters=exclude_application_parameters,
            timeout=timeout,
            template_url=self.get_application_info.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_application_health(
        ...
        **kwargs: Any
        ...
        request = build_get_application_health_request(
            ...
            exclude_health_statistics=exclude_health_statistics,
            timeout=timeout,
            template_url=self.get_application_health.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_application_health_using_policy(
        ...
        **kwargs: Any
        ...
        if application_health_policy is not None:
            _json = self._serialize.body(application_health_policy, 'ApplicationHealthPolicy')
        else:
            _json = None
        ...
        request = build_get_application_health_using_policy_request(
            ...
            exclude_health_statistics=exclude_health_statistics,
            timeout=timeout,
            template_url=self.get_application_health_using_policy.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def report_application_health(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_report_application_health_request(
            ...
            immediate=immediate,
            timeout=timeout,
            template_url=self.report_application_health.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def start_application_upgrade(  # pylint: disable=inconsistent-return-statements
        self,
        application_id: str,
        application_upgrade_description: "_models.ApplicationUpgradeDescription",
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> None:
        ...
        request = build_start_application_upgrade_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.start_application_upgrade.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_application_upgrade(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.ApplicationUpgradeProgressInfo":
        ...
        request = build_get_application_upgrade_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_application_upgrade.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def update_application_upgrade(  # pylint: disable=inconsistent-return-statements
        self,
        application_id: str,
        application_upgrade_update_description: "_models.ApplicationUpgradeUpdateDescription",
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> None:
        ...
        request = build_update_application_upgrade_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.update_application_upgrade.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def update_application(  # pylint: disable=inconsistent-return-statements
        self,
        application_id: str,
        application_update_description: "_models.ApplicationUpdateDescription",
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> None:
        ...
        :param application_update_description: Parameters for updating an existing application
         instance.
        :type application_update_description: ~azure.servicefabric.models.ApplicationUpdateDescription
        :param timeout: The server timeout for performing the operation in seconds. This timeout
         specifies the time duration that the client is willing to wait for the requested operation to
         complete. The default value for this parameter is 60 seconds. Default value is 60.
        :type timeout: long
        ...
        request = build_update_application_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.update_application.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    update_application.metadata = {'url': "/Applications/{applicationId}/$/Update"}  # type: ignore
    ...
    async def resume_application_upgrade(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        _json = self._serialize.body(_resume_application_upgrade_description, 'ResumeApplicationUpgradeDescription')
        ...
        request = build_resume_application_upgrade_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.resume_application_upgrade.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def rollback_application_upgrade(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_rollback_application_upgrade_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.rollback_application_upgrade.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_deployed_application_info_list(
        ...
        max_results: Optional[int] = 0,
        **kwargs: Any
    ) -> "_models.PagedDeployedApplicationInfoList":
        ...
        request = build_get_deployed_application_info_list_request(
            ...
            continuation_token_parameter=continuation_token_parameter,
            max_results=max_results,
            template_url=self.get_deployed_application_info_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_deployed_application_info(
        ...
        include_health_state: Optional[bool] = False,
        **kwargs: Any
    ) -> Optional["_models.DeployedApplicationInfo"]:
        ...
        request = build_get_deployed_application_info_request(
            ...
            timeout=timeout,
            include_health_state=include_health_state,
            template_url=self.get_deployed_application_info.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_deployed_application_health(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.DeployedApplicationHealth":
        ...
        request = build_get_deployed_application_health_request(
            ...
            exclude_health_statistics=exclude_health_statistics,
            timeout=timeout,
            template_url=self.get_deployed_application_health.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_deployed_application_health_using_policy(
        ...
        **kwargs: Any
        ...
        request = build_get_deployed_application_health_using_policy_request(
            ...
            exclude_health_statistics=exclude_health_statistics,
            timeout=timeout,
            template_url=self.get_deployed_application_health_using_policy.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def report_deployed_application_health(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_report_deployed_application_health_request(
            ...
            immediate=immediate,
            timeout=timeout,
            template_url=self.report_deployed_application_health.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_application_manifest(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.ApplicationTypeManifest":
        ...
        request = build_get_application_manifest_request(
            ...
            application_type_version=application_type_version,
            timeout=timeout,
            template_url=self.get_application_manifest.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def update_application_arm_metadata(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        _json = self._serialize.body(_application_arm_metadata_update_description, 'ArmMetadata')
        ...
        request = build_update_application_arm_metadata_request(
            ...
            timeout=timeout,
            force=force,
            template_url=self.update_application_arm_metadata.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    update_application_arm_metadata.metadata = {'url': "/Applications/{applicationId}/$/UpdateArmMetadata"}  # type: ignore
    ...
    async def get_service_info_list(
        ...
        **kwargs: Any
        ...
        request = build_get_service_info_list_request(
            ...
            continuation_token_parameter=continuation_token_parameter,
            timeout=timeout,
            template_url=self.get_service_info_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_service_info(
        ...
        **kwargs: Any
        ...
        request = build_get_service_info_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_service_info.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_application_name_info(
        ...
        **kwargs: Any
        ...
        request = build_get_application_name_info_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_application_name_info.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def create_service(  # pylint: disable=inconsistent-return-statements
        self,
        application_id: str,
        service_description: "_models.ServiceDescription",
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> None:
        ...
        request = build_create_service_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.create_service.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def create_service_from_template(  # pylint: disable=inconsistent-return-statements
        self,
        application_id: str,
        service_from_template_description: "_models.ServiceFromTemplateDescription",
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> None:
        ...
        request = build_create_service_from_template_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.create_service_from_template.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def delete_service(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_delete_service_request(
            ...
            force_remove=force_remove,
            timeout=timeout,
            template_url=self.delete_service.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def update_service(  # pylint: disable=inconsistent-return-statements
        self,
        service_id: str,
        service_update_description: "_models.ServiceUpdateDescription",
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> None:
        ...
        request = build_update_service_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.update_service.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_service_description(
        ...
        **kwargs: Any
        ...
        request = build_get_service_description_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_service_description.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_service_health(
        ...
        **kwargs: Any
        ...
        request = build_get_service_health_request(
            ...
            exclude_health_statistics=exclude_health_statistics,
            timeout=timeout,
            template_url=self.get_service_health.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_service_health_using_policy(
        ...
        **kwargs: Any
        ...
        request = build_get_service_health_using_policy_request(
            ...
            exclude_health_statistics=exclude_health_statistics,
            timeout=timeout,
            template_url=self.get_service_health_using_policy.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def report_service_health(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_report_service_health_request(
            ...
            immediate=immediate,
            timeout=timeout,
            template_url=self.report_service_health.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def resolve_service(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.ResolvedServicePartition":
        ...
        request = build_resolve_service_request(
            ...
            timeout=timeout,
            template_url=self.resolve_service.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_unplaced_replica_information(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.UnplacedReplicaInformation":
        ...
        request = build_get_unplaced_replica_information_request(
            ...
            timeout=timeout,
            template_url=self.get_unplaced_replica_information.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_loaded_partition_info_list(
        ...
        ordering: Optional[Union[str, "_models.Ordering"]] = None,
        max_results: Optional[int] = 0,
        continuation_token_parameter: Optional[str] = None,
        **kwargs: Any
    ) -> "_models.LoadedPartitionInformationResultList":
        ...
        :param ordering: Ordering of partitions' load. Default value is None.
        ...
        request = build_get_loaded_partition_info_list_request(
            ...
            max_results=max_results,
            continuation_token_parameter=continuation_token_parameter,
            template_url=self.get_loaded_partition_info_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_partition_info_list(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.PagedServicePartitionInfoList":
        ...
        request = build_get_partition_info_list_request(
            ...
            continuation_token_parameter=continuation_token_parameter,
            timeout=timeout,
            template_url=self.get_partition_info_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_partition_info(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> Optional["_models.ServicePartitionInfo"]:
        ...
        request = build_get_partition_info_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_partition_info.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_service_name_info(
        ...
        **kwargs: Any
        ...
        request = build_get_service_name_info_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_service_name_info.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_partition_health(
        ...
        **kwargs: Any
        ...
        request = build_get_partition_health_request(
            ...
            exclude_health_statistics=exclude_health_statistics,
            timeout=timeout,
            template_url=self.get_partition_health.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_partition_health_using_policy(
        ...
        **kwargs: Any
        ...
        request = build_get_partition_health_using_policy_request(
            ...
            exclude_health_statistics=exclude_health_statistics,
            timeout=timeout,
            template_url=self.get_partition_health_using_policy.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def report_partition_health(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_report_partition_health_request(
            ...
            immediate=immediate,
            timeout=timeout,
            template_url=self.report_partition_health.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_partition_load_information(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.PartitionLoadInformation":
        ...
        request = build_get_partition_load_information_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_partition_load_information.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def reset_partition_load(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_reset_partition_load_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.reset_partition_load.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def recover_partition(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_recover_partition_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.recover_partition.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def recover_service_partitions(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_recover_service_partitions_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.recover_service_partitions.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def recover_system_partitions(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_recover_system_partitions_request(
            api_version=api_version,
            timeout=timeout,
            template_url=self.recover_system_partitions.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def recover_all_partitions(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_recover_all_partitions_request(
            api_version=api_version,
            timeout=timeout,
            template_url=self.recover_all_partitions.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def move_primary_replica(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_move_primary_replica_request(
            ...
            timeout=timeout,
            template_url=self.move_primary_replica.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def move_secondary_replica(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_move_secondary_replica_request(
            ...
            ignore_constraints=ignore_constraints,
            timeout=timeout,
            template_url=self.move_secondary_replica.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def update_partition_load(
        self,
        partition_metric_load_description_list: List["_models.PartitionMetricLoadDescription"],
        continuation_token_parameter: Optional[str] = None,
        max_results: Optional[int] = 0,
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.PagedUpdatePartitionLoadResultList":
        ...
        request = build_update_partition_load_request(
            ...
            max_results=max_results,
            timeout=timeout,
            template_url=self.update_partition_load.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def move_instance(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_move_instance_request(
            ...
            ignore_constraints=ignore_constraints,
            timeout=timeout,
            template_url=self.move_instance.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def move_auxiliary_replica(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_move_auxiliary_replica_request(
            ...
            ignore_constraints=ignore_constraints,
            timeout=timeout,
            template_url=self.move_auxiliary_replica.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    move_auxiliary_replica.metadata = {'url': "/Services/{serviceId}/$/GetPartitions/{partitionId}/$/MoveAuxiliaryReplica"}  # type: ignore


    @distributed_trace_async
    async def create_repair_task(
        self,
        repair_task: "_models.RepairTask",
        **kwargs: Any
    ) -> "_models.RepairTaskUpdateInfo":
        ...
        request = build_create_repair_task_request(
            ...
            content_type=content_type,
            json=_json,
            template_url=self.create_repair_task.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def cancel_repair_task(
        self,
        repair_task_cancel_description: "_models.RepairTaskCancelDescription",
        **kwargs: Any
    ) -> "_models.RepairTaskUpdateInfo":
        ...
        request = build_cancel_repair_task_request(
            ...
            content_type=content_type,
            json=_json,
            template_url=self.cancel_repair_task.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def delete_repair_task(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param version: The current version number of the repair task. If non-zero, then the request
         ...
         then no version check is performed. Default value is None.
        :type version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        ...
        _json = self._serialize.body(_repair_task_delete_description, 'RepairTaskDeleteDescription')

        request = build_delete_repair_task_request(
            api_version=api_version,
            content_type=content_type,
            json=_json,
            template_url=self.delete_repair_task.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_repair_task_list(
        ...
        **kwargs: Any
        ...
        request = build_get_repair_task_list_request(
            ...
            template_url=self.get_repair_task_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def force_approve_repair_task(
        ...
        **kwargs: Any
        ...
        _json = self._serialize.body(_repair_task_approve_description, 'RepairTaskApproveDescription')

        request = build_force_approve_repair_task_request(
            api_version=api_version,
            content_type=content_type,
            json=_json,
            template_url=self.force_approve_repair_task.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def update_repair_task_health_policy(
        self,
        repair_task_update_health_policy_description: "_models.RepairTaskUpdateHealthPolicyDescription",
        **kwargs: Any
    ) -> "_models.RepairTaskUpdateInfo":
        ...
        request = build_update_repair_task_health_policy_request(
            ...
            content_type=content_type,
            json=_json,
            template_url=self.update_repair_task_health_policy.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def update_repair_execution_state(
        ...
        **kwargs: Any
        ...
        request = build_update_repair_execution_state_request(
            ...
            content_type=content_type,
            json=_json,
            template_url=self.update_repair_execution_state.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_replica_info_list(
        ...
        **kwargs: Any
        ...
        request = build_get_replica_info_list_request(
            ...
            continuation_token_parameter=continuation_token_parameter,
            timeout=timeout,
            template_url=self.get_replica_info_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_replica_info(
        ...
        **kwargs: Any
        ...
        request = build_get_replica_info_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_replica_info.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_replica_health(
        ...
        **kwargs: Any
        ...
        request = build_get_replica_health_request(
            ...
            events_health_state_filter=events_health_state_filter,
            timeout=timeout,
            template_url=self.get_replica_health.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_replica_health_using_policy(
        ...
        **kwargs: Any
        ...
        request = build_get_replica_health_using_policy_request(
            ...
            events_health_state_filter=events_health_state_filter,
            timeout=timeout,
            template_url=self.get_replica_health_using_policy.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def report_replica_health(  # pylint: disable=inconsistent-return-statements
        ...
        replica_id: str,
        health_information: "_models.HealthInformation",
        service_kind: Union[str, "_models.ReplicaHealthReportServiceKind"] = "Stateful",
        immediate: Optional[bool] = False,
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> None:
        ...
        :param service_kind: The kind of service replica (Stateless or Stateful) for which the health
         is being reported. Following are the possible values. Default value is "Stateful".
        ...
        request = build_report_replica_health_request(
            ...
            immediate=immediate,
            timeout=timeout,
            template_url=self.report_replica_health.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_deployed_service_replica_info_list(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> Optional[List["_models.DeployedServiceReplicaInfo"]]:
        ...
        request = build_get_deployed_service_replica_info_list_request(
            ...
            service_manifest_name=service_manifest_name,
            timeout=timeout,
            template_url=self.get_deployed_service_replica_info_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_deployed_service_replica_detail_info(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.DeployedServiceReplicaDetailInfo":
        ...
        request = build_get_deployed_service_replica_detail_info_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_deployed_service_replica_detail_info.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_deployed_service_replica_detail_info_by_partition_id(
        ...
        **kwargs: Any
        ...
        request = build_get_deployed_service_replica_detail_info_by_partition_id_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_deployed_service_replica_detail_info_by_partition_id.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def restart_replica(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_restart_replica_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.restart_replica.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def remove_replica(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_remove_replica_request(
            ...
            force_remove=force_remove,
            timeout=timeout,
            template_url=self.remove_replica.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_deployed_service_package_info_list(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> List["_models.DeployedServicePackageInfo"]:
        ...
        request = build_get_deployed_service_package_info_list_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_deployed_service_package_info_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_deployed_service_package_info_list_by_name(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> Optional[List["_models.DeployedServicePackageInfo"]]:
        ...
        request = build_get_deployed_service_package_info_list_by_name_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_deployed_service_package_info_list_by_name.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_deployed_service_package_health(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.DeployedServicePackageHealth":
        ...
        request = build_get_deployed_service_package_health_request(
            ...
            events_health_state_filter=events_health_state_filter,
            timeout=timeout,
            template_url=self.get_deployed_service_package_health.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_deployed_service_package_health_using_policy(
        ...
        **kwargs: Any
        ...
        request = build_get_deployed_service_package_health_using_policy_request(
            ...
            events_health_state_filter=events_health_state_filter,
            timeout=timeout,
            template_url=self.get_deployed_service_package_health_using_policy.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def report_deployed_service_package_health(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_report_deployed_service_package_health_request(
            ...
            immediate=immediate,
            timeout=timeout,
            template_url=self.report_deployed_service_package_health.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def deploy_service_package_to_node(  # pylint: disable=inconsistent-return-statements
        self,
        node_name: str,
        deploy_service_package_to_node_description: "_models.DeployServicePackageToNodeDescription",
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> None:
        ...
        request = build_deploy_service_package_to_node_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.deploy_service_package_to_node.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_deployed_code_package_info_list(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> List["_models.DeployedCodePackageInfo"]:
        ...
        :param code_package_name: The name of code package specified in service manifest registered as
         part of an application type in a Service Fabric cluster. Default value is None.
        ...
        request = build_get_deployed_code_package_info_list_request(
            ...
            timeout=timeout,
            template_url=self.get_deployed_code_package_info_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def restart_deployed_code_package(  # pylint: disable=inconsistent-return-statements
        ...
        node_name: str,
        application_id: str,
        restart_deployed_code_package_description: "_models.RestartDeployedCodePackageDescription",
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> None:
        ...
        request = build_restart_deployed_code_package_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.restart_deployed_code_package.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_container_logs_deployed_on_node(
        ...
        **kwargs: Any
        ...
        request = build_get_container_logs_deployed_on_node_request(
            ...
            previous=previous,
            timeout=timeout,
            template_url=self.get_container_logs_deployed_on_node.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def invoke_container_api(
        ...
        container_api_request_body: "_models.ContainerApiRequestBody",
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.ContainerApiResponse":
        ...
        request = build_invoke_container_api_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.invoke_container_api.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def create_compose_deployment(  # pylint: disable=inconsistent-return-statements
        self,
        create_compose_deployment_description: "_models.CreateComposeDeploymentDescription",
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> None:
        ...
        request = build_create_compose_deployment_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.create_compose_deployment.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_compose_deployment_status(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.ComposeDeploymentStatusInfo":
        ...
        request = build_get_compose_deployment_status_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_compose_deployment_status.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_compose_deployment_status_list(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.PagedComposeDeploymentStatusInfoList":
        ...
        request = build_get_compose_deployment_status_list_request(
            ...
            max_results=max_results,
            timeout=timeout,
            template_url=self.get_compose_deployment_status_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_compose_deployment_upgrade_progress(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.ComposeDeploymentUpgradeProgressInfo":
        ...
        request = build_get_compose_deployment_upgrade_progress_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_compose_deployment_upgrade_progress.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def remove_compose_deployment(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_remove_compose_deployment_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.remove_compose_deployment.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def start_compose_deployment_upgrade(  # pylint: disable=inconsistent-return-statements
        self,
        deployment_name: str,
        compose_deployment_upgrade_description: "_models.ComposeDeploymentUpgradeDescription",
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> None:
        ...
        request = build_start_compose_deployment_upgrade_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.start_compose_deployment_upgrade.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def start_rollback_compose_deployment_upgrade(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_start_rollback_compose_deployment_upgrade_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.start_rollback_compose_deployment_upgrade.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_chaos(
        ...
        **kwargs: Any
        ...
        request = build_get_chaos_request(
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_chaos.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def start_chaos(  # pylint: disable=inconsistent-return-statements
        self,
        chaos_parameters: "_models.ChaosParameters",
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> None:
        ...
        request = build_start_chaos_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.start_chaos.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def stop_chaos(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_stop_chaos_request(
            api_version=api_version,
            timeout=timeout,
            template_url=self.stop_chaos.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_chaos_events(
        ...
        **kwargs: Any
        ...
        request = build_get_chaos_events_request(
            ...
            max_results=max_results,
            timeout=timeout,
            template_url=self.get_chaos_events.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_chaos_schedule(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.ChaosScheduleDescription":
    ...
    async def post_chaos_schedule(  # pylint: disable=inconsistent-return-statements
        ...
        schedule: Optional["_models.ChaosSchedule"] = None,
        **kwargs: Any
    ) -> None:
        ...
        :param timeout: The server timeout for performing the operation in seconds. This timeout
         ...
         complete. The default value for this parameter is 60 seconds. Default value is 60.
        :type timeout: long
        :param version: The version number of the Schedule. Default value is None.
        :type version: int
        :param schedule: Defines the schedule used by Chaos. Default value is None.
        ...
        _json = self._serialize.body(_chaos_schedule, 'ChaosScheduleDescription')
        ...
        request = build_post_chaos_schedule_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.post_chaos_schedule.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_image_store_content(
        ...
        **kwargs: Any
        ...
        request = build_get_image_store_content_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_image_store_content.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def delete_image_store_content(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_delete_image_store_content_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.delete_image_store_content.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_image_store_root_content(
        ...
        **kwargs: Any
        ...
        request = build_get_image_store_root_content_request(
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_image_store_root_content.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def copy_image_store_content(  # pylint: disable=inconsistent-return-statements
        self,
        image_store_copy_description: "_models.ImageStoreCopyDescription",
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> None:
        ...
        request = build_copy_image_store_content_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.copy_image_store_content.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def delete_image_store_upload_session(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_delete_image_store_upload_session_request(
            ...
            timeout=timeout,
            template_url=self.delete_image_store_upload_session.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def commit_image_store_upload_session(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_commit_image_store_upload_session_request(
            ...
            session_id=session_id,
            timeout=timeout,
            template_url=self.commit_image_store_upload_session.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_image_store_upload_session_by_id(
        ...
        **kwargs: Any
        ...
        request = build_get_image_store_upload_session_by_id_request(
            ...
            session_id=session_id,
            timeout=timeout,
            template_url=self.get_image_store_upload_session_by_id.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_image_store_upload_session_by_path(
        ...
        **kwargs: Any
        ...
        request = build_get_image_store_upload_session_by_path_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_image_store_upload_session_by_path.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def upload_file_chunk(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_upload_file_chunk_request(
            ...
            timeout=timeout,
            template_url=self.upload_file_chunk.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_image_store_root_folder_size(
        ...
        **kwargs: Any
        ...
        request = build_get_image_store_root_folder_size_request(
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_image_store_root_folder_size.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_image_store_folder_size(
        ...
        **kwargs: Any
        ...
        request = build_get_image_store_folder_size_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_image_store_folder_size.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_image_store_info(
        ...
        **kwargs: Any
        ...
        request = build_get_image_store_info_request(
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_image_store_info.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def invoke_infrastructure_command(
        ...
        **kwargs: Any
        ...
        request = build_invoke_infrastructure_command_request(
            ...
            service_id=service_id,
            timeout=timeout,
            template_url=self.invoke_infrastructure_command.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def invoke_infrastructure_query(
        ...
        **kwargs: Any
        ...
        request = build_invoke_infrastructure_query_request(
            ...
            service_id=service_id,
            timeout=timeout,
            template_url=self.invoke_infrastructure_query.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def start_data_loss(  # pylint: disable=inconsistent-return-statements
        ...
        partition_id: str,
        operation_id: str,
        data_loss_mode: Union[str, "_models.DataLossMode"],
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> None:
        ...
        * FullDataLoss - All replicas are removed hence all data is lost and OnDataLoss is triggered.
        ...
        request = build_start_data_loss_request(
            ...
            timeout=timeout,
            template_url=self.start_data_loss.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_data_loss_progress(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.PartitionDataLossProgress":
        ...
        request = build_get_data_loss_progress_request(
            ...
            operation_id=operation_id,
            timeout=timeout,
            template_url=self.get_data_loss_progress.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def start_quorum_loss(  # pylint: disable=inconsistent-return-statements
        ...
        partition_id: str,
        operation_id: str,
        quorum_loss_mode: Union[str, "_models.QuorumLossMode"],
        ...
        **kwargs: Any
        ...
        request = build_start_quorum_loss_request(
            ...
            timeout=timeout,
            template_url=self.start_quorum_loss.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_quorum_loss_progress(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.PartitionQuorumLossProgress":
        ...
        request = build_get_quorum_loss_progress_request(
            ...
            operation_id=operation_id,
            timeout=timeout,
            template_url=self.get_quorum_loss_progress.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def start_partition_restart(  # pylint: disable=inconsistent-return-statements
        ...
        partition_id: str,
        operation_id: str,
        restart_partition_mode: Union[str, "_models.RestartPartitionMode"],
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> None:
        ...
        request = build_start_partition_restart_request(
            ...
            timeout=timeout,
            template_url=self.start_partition_restart.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_partition_restart_progress(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.PartitionRestartProgress":
        ...
        request = build_get_partition_restart_progress_request(
            ...
            operation_id=operation_id,
            timeout=timeout,
            template_url=self.get_partition_restart_progress.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def start_node_transition(  # pylint: disable=inconsistent-return-statements
        ...
        node_name: str,
        operation_id: str,
        node_transition_type: Union[str, "_models.NodeTransitionType"],
        ...
        **kwargs: Any
        ...
        request = build_start_node_transition_request(
            ...
            timeout=timeout,
            template_url=self.start_node_transition.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_node_transition_progress(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.NodeTransitionProgress":
        ...
        request = build_get_node_transition_progress_request(
            ...
            operation_id=operation_id,
            timeout=timeout,
            template_url=self.get_node_transition_progress.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_fault_operation_list(
        ...
        **kwargs: Any
        ...
        request = build_get_fault_operation_list_request(
            ...
            state_filter=state_filter,
            timeout=timeout,
            template_url=self.get_fault_operation_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def create_backup_policy(  # pylint: disable=inconsistent-return-statements
        self,
        backup_policy_description: "_models.BackupPolicyDescription",
        timeout: Optional[int] = 60,
        ...
        **kwargs: Any
        ...
        request = build_create_backup_policy_request(
            ...
            template_url=self.create_backup_policy.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def delete_backup_policy(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_delete_backup_policy_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.delete_backup_policy.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_backup_policy_list(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.PagedBackupPolicyDescriptionList":
        ...
        request = build_get_backup_policy_list_request(
            ...
            max_results=max_results,
            timeout=timeout,
            template_url=self.get_backup_policy_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_backup_policy_by_name(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.BackupPolicyDescription":
        ...
        request = build_get_backup_policy_by_name_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_backup_policy_by_name.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_all_entities_backed_up_by_policy(
        ...
        **kwargs: Any
        ...
        request = build_get_all_entities_backed_up_by_policy_request(
            ...
            max_results=max_results,
            timeout=timeout,
            template_url=self.get_all_entities_backed_up_by_policy.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def update_backup_policy(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_update_backup_policy_request(
            ...
            timeout=timeout,
            validate_connection=validate_connection,
            template_url=self.update_backup_policy.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def enable_application_backup(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        _json = self._serialize.body(_enable_backup_description, 'EnableBackupDescription')
        ...
        request = build_enable_application_backup_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.enable_application_backup.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def disable_application_backup(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        if _disable_backup_description is not None:
            _json = self._serialize.body(_disable_backup_description, 'DisableBackupDescription')
        else:
            _json = None
        ...
        request = build_disable_application_backup_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.disable_application_backup.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_application_backup_configuration_info(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.PagedBackupConfigurationInfoList":
        ...
        request = build_get_application_backup_configuration_info_request(
            ...
            max_results=max_results,
            timeout=timeout,
            template_url=self.get_application_backup_configuration_info.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_application_backup_list(
        ...
        **kwargs: Any
        ...
        request = build_get_application_backup_list_request(
            ...
            continuation_token_parameter=continuation_token_parameter,
            max_results=max_results,
            template_url=self.get_application_backup_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def suspend_application_backup(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_suspend_application_backup_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.suspend_application_backup.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def resume_application_backup(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_resume_application_backup_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.resume_application_backup.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def enable_service_backup(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_enable_service_backup_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.enable_service_backup.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def disable_service_backup(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_disable_service_backup_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.disable_service_backup.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_service_backup_configuration_info(
        ...
        **kwargs: Any
        ...
        request = build_get_service_backup_configuration_info_request(
            ...
            max_results=max_results,
            timeout=timeout,
            template_url=self.get_service_backup_configuration_info.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_service_backup_list(
        ...
        **kwargs: Any
        ...
        request = build_get_service_backup_list_request(
            ...
            continuation_token_parameter=continuation_token_parameter,
            max_results=max_results,
            template_url=self.get_service_backup_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def suspend_service_backup(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_suspend_service_backup_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.suspend_service_backup.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def resume_service_backup(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_resume_service_backup_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.resume_service_backup.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def enable_partition_backup(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_enable_partition_backup_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.enable_partition_backup.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def disable_partition_backup(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_disable_partition_backup_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.disable_partition_backup.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_partition_backup_configuration_info(
        ...
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> "_models.PartitionBackupConfigurationInfo":
        ...
        request = build_get_partition_backup_configuration_info_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_partition_backup_configuration_info.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_partition_backup_list(
        ...
        **kwargs: Any
        ...
        request = build_get_partition_backup_list_request(
            ...
            start_date_time_filter=start_date_time_filter,
            end_date_time_filter=end_date_time_filter,
            template_url=self.get_partition_backup_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def suspend_partition_backup(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_suspend_partition_backup_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.suspend_partition_backup.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def resume_partition_backup(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_resume_partition_backup_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.resume_partition_backup.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def backup_partition(  # pylint: disable=inconsistent-return-statements
        ...
        timeout: Optional[int] = 60,
        backup_storage: Optional["_models.BackupStorageDescription"] = None,
        **kwargs: Any
    ) -> None:
        ...
        if _backup_partition_description is not None:
            _json = self._serialize.body(_backup_partition_description, 'BackupPartitionDescription')
        else:
            _json = None
        ...
        request = build_backup_partition_request(
            ...
            timeout=timeout,
            template_url=self.backup_partition.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_partition_backup_progress(
        ...
        **kwargs: Any
        ...
        request = build_get_partition_backup_progress_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_partition_backup_progress.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def restore_partition(  # pylint: disable=inconsistent-return-statements
        self,
        partition_id: str,
        restore_partition_description: "_models.RestorePartitionDescription",
        ...
        **kwargs: Any
        ...
        request = build_restore_partition_request(
            ...
            timeout=timeout,
            template_url=self.restore_partition.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_partition_restore_progress(
        ...
        **kwargs: Any
        ...
        request = build_get_partition_restore_progress_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_partition_restore_progress.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_backups_from_backup_location(
        self,
        get_backup_by_storage_query_description: "_models.GetBackupByStorageQueryDescription",
        timeout: Optional[int] = 60,
        continuation_token_parameter: Optional[str] = None,
        max_results: Optional[int] = 0,
        **kwargs: Any
        ...
        request = build_get_backups_from_backup_location_request(
            ...
            continuation_token_parameter=continuation_token_parameter,
            max_results=max_results,
            template_url=self.get_backups_from_backup_location.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def create_name(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        _json = self._serialize.body(_name_description, 'NameDescription')
        ...
        request = build_create_name_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.create_name.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_name_exists_info(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_get_name_exists_info_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_name_exists_info.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def delete_name(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_delete_name_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.delete_name.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_sub_name_info_list(
        ...
        **kwargs: Any
        ...
        :param name_id: The Service Fabric name, without the 'fabric:' URI scheme.
        :type name_id: str
        :param recursive: Allows specifying that the search performed should be recursive. Default
         value is False.
        :type recursive: bool
        :param continuation_token_parameter: The continuation token parameter is used to obtain next
         set of results. A continuation token with a non-empty value is included in the response of the
        ...
        request = build_get_sub_name_info_list_request(
            ...
            continuation_token_parameter=continuation_token_parameter,
            timeout=timeout,
            template_url=self.get_sub_name_info_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_property_info_list(
        ...
        **kwargs: Any
        ...
        request = build_get_property_info_list_request(
            ...
            continuation_token_parameter=continuation_token_parameter,
            timeout=timeout,
            template_url=self.get_property_info_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def put_property(  # pylint: disable=inconsistent-return-statements
        self,
        name_id: str,
        property_description: "_models.PropertyDescription",
        timeout: Optional[int] = 60,
        **kwargs: Any
    ) -> None:
        ...
        request = build_put_property_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.put_property.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_property_info(
        ...
        **kwargs: Any
        ...
        request = build_get_property_info_request(
            ...
            timeout=timeout,
            template_url=self.get_property_info.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def delete_property(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_delete_property_request(
            ...
            property_name=property_name,
            timeout=timeout,
            template_url=self.delete_property.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def submit_property_batch(
        ...
        name_id: str,
        timeout: Optional[int] = 60,
        operations: Optional[List["_models.PropertyBatchOperation"]] = None,
        **kwargs: Any
    ) -> Union["_models.SuccessfulPropertyBatchInfo", "_models.FailedPropertyBatchInfo"]:
        ...
        :param timeout: The server timeout for performing the operation in seconds. This timeout
         ...
         complete. The default value for this parameter is 60 seconds. Default value is 60.
        :type timeout: long
        :param operations: A list of the property batch operations to be executed. Default value is
         None.
        ...
        :rtype: ~azure.servicefabric.models.SuccessfulPropertyBatchInfo or
         ~azure.servicefabric.models.FailedPropertyBatchInfo
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        _json = self._serialize.body(_property_batch_description_list, 'PropertyBatchDescriptionList')
        ...
        request = build_submit_property_batch_request(
            ...
            json=_json,
            timeout=timeout,
            template_url=self.submit_property_batch.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_cluster_event_list(
        ...
        **kwargs: Any
        ...
        :param skip_correlation_lookup: This param disables the search of CorrelatedEvents information
         ...
         in every FabricEvent gets populated. Default value is None.
        ...
        request = build_get_cluster_event_list_request(
            ...
            template_url=self.get_cluster_event_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_containers_event_list(
        ...
        skip_correlation_lookup: Optional[bool] = None,
        **kwargs: Any
    ) -> List["_models.ContainerInstanceEvent"]:
        ...
        request = build_get_containers_event_list_request(
            ...
            exclude_analysis_events=exclude_analysis_events,
            skip_correlation_lookup=skip_correlation_lookup,
            template_url=self.get_containers_event_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_node_event_list(
        ...
        **kwargs: Any
        ...
        request = build_get_node_event_list_request(
            ...
            exclude_analysis_events=exclude_analysis_events,
            skip_correlation_lookup=skip_correlation_lookup,
            template_url=self.get_node_event_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_nodes_event_list(
        ...
        **kwargs: Any
        ...
        request = build_get_nodes_event_list_request(
            ...
            exclude_analysis_events=exclude_analysis_events,
            skip_correlation_lookup=skip_correlation_lookup,
            template_url=self.get_nodes_event_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_application_event_list(
        ...
        **kwargs: Any
        ...
        request = build_get_application_event_list_request(
            ...
            exclude_analysis_events=exclude_analysis_events,
            skip_correlation_lookup=skip_correlation_lookup,
            template_url=self.get_application_event_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_applications_event_list(
        ...
        **kwargs: Any
        ...
        request = build_get_applications_event_list_request(
            ...
            exclude_analysis_events=exclude_analysis_events,
            skip_correlation_lookup=skip_correlation_lookup,
            template_url=self.get_applications_event_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_service_event_list(
        ...
        **kwargs: Any
        ...
        request = build_get_service_event_list_request(
            ...
            exclude_analysis_events=exclude_analysis_events,
            skip_correlation_lookup=skip_correlation_lookup,
            template_url=self.get_service_event_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_services_event_list(
        ...
        **kwargs: Any
        ...
        request = build_get_services_event_list_request(
            ...
            exclude_analysis_events=exclude_analysis_events,
            skip_correlation_lookup=skip_correlation_lookup,
            template_url=self.get_services_event_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_partition_event_list(
        ...
        **kwargs: Any
        ...
        request = build_get_partition_event_list_request(
            ...
            exclude_analysis_events=exclude_analysis_events,
            skip_correlation_lookup=skip_correlation_lookup,
            template_url=self.get_partition_event_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_partitions_event_list(
        ...
        **kwargs: Any
        ...
        request = build_get_partitions_event_list_request(
            ...
            exclude_analysis_events=exclude_analysis_events,
            skip_correlation_lookup=skip_correlation_lookup,
            template_url=self.get_partitions_event_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_partition_replica_event_list(
        ...
        **kwargs: Any
        ...
        request = build_get_partition_replica_event_list_request(
            ...
            exclude_analysis_events=exclude_analysis_events,
            skip_correlation_lookup=skip_correlation_lookup,
            template_url=self.get_partition_replica_event_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_partition_replicas_event_list(
        ...
        **kwargs: Any
        ...
        request = build_get_partition_replicas_event_list_request(
            ...
            exclude_analysis_events=exclude_analysis_events,
            skip_correlation_lookup=skip_correlation_lookup,
            template_url=self.get_partition_replicas_event_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    async def get_correlated_event_list(
        ...
        **kwargs: Any
        ...
        request = build_get_correlated_event_list_request(
            ...
            api_version=api_version,
            timeout=timeout,
            template_url=self.get_correlated_event_list.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
