...
class ServiceFabricClientAPIsOperationsMixin:
    ...
    async def get_cluster_manifest(
        ...
        **kwargs
        ...
        These properties are specified as part of the ClusterConfig.JSON file while deploying a stand-
        alone cluster. However, most of the information in the cluster manifest
    ...
    async def report_cluster_health(
        self,
    ...
    async def rollback_cluster_upgrade(
        self,
        timeout: Optional[int] = 60,
        **kwargs
    ) -> None:
    ...
    async def resume_cluster_upgrade(
        self,
        upgrade_domain: str,
        timeout: Optional[int] = 60,
        **kwargs
    ...
    async def start_cluster_upgrade(
        self,
    ...
    async def start_cluster_configuration_upgrade(
        self,
    ...
    async def update_cluster_upgrade(
        self,
    ...
    async def toggle_verbose_service_placement_health_reporting(
        self,
        enabled: bool,
        timeout: Optional[int] = 60,
        **kwargs
    ...
    async def remove_node_state(
        ...
        **kwargs
        ...
        https://docs.microsoft.com/azure/service-fabric/service-fabric-cluster-windows-server-add-
        remove-nodes.
    ...
    async def remove_configuration_overrides(
        self,
        node_name: str,
        timeout: Optional[int] = 60,
        **kwargs
    ...
    async def add_configuration_parameter_overrides(
        self,
        node_name: str,
    ...
    async def provision_application_type(
        self,
    ...
    async def unprovision_application_type(
        self,
        application_type_name: str,
    ...
    async def report_application_health(
        self,
        application_id: str,
        health_information: "_models.HealthInformation",
        immediate: Optional[bool] = False,
    ...
    async def start_application_upgrade(
        self,
        application_id: str,
    ...
    async def update_application_upgrade(
        self,
        application_id: str,
    ...
    async def resume_application_upgrade(
        self,
        application_id: str,
    ...
    async def rollback_application_upgrade(
        self,
        application_id: str,
        timeout: Optional[int] = 60,
        **kwargs
    ...
    async def report_deployed_application_health(
        self,
        node_name: str,
        application_id: str,
        health_information: "_models.HealthInformation",
    ...
    async def report_partition_health(
        self,
        partition_id: str,
        health_information: "_models.HealthInformation",
        immediate: Optional[bool] = False,
    ...
    async def reset_partition_load(
        self,
        partition_id: str,
        timeout: Optional[int] = 60,
        **kwargs
    ...
    async def recover_service_partitions(
        self,
        service_id: str,
        timeout: Optional[int] = 60,
        **kwargs
    ...
    async def recover_system_partitions(
        self,
        timeout: Optional[int] = 60,
        **kwargs
    ) -> None:
    ...
    async def recover_all_partitions(
        self,
        timeout: Optional[int] = 60,
        **kwargs
    ) -> None:
    ...
    async def move_primary_replica(
        self,
        partition_id: str,
    ...
    async def move_secondary_replica(
        self,
        partition_id: str,
    ...
    async def report_replica_health(
        self,
        partition_id: str,
        replica_id: str,
        health_information: "_models.HealthInformation",
    ...
    async def report_deployed_service_package_health(
        self,
        node_name: str,
        application_id: str,
        service_package_name: str,
    ...
    async def deploy_service_package_to_node(
        self,
        node_name: str,
    ...
    async def restart_deployed_code_package(
        self,
        node_name: str,
        application_id: str,
    ...
    async def create_compose_deployment(
        self,
    ...
    async def start_compose_deployment_upgrade(
        self,
        deployment_name: str,
    ...
    async def start_rollback_compose_deployment_upgrade(
        self,
        deployment_name: str,
        timeout: Optional[int] = 60,
        **kwargs
    ...
    async def delete_image_store_content(
        self,
        content_path: str,
        timeout: Optional[int] = 60,
        **kwargs
    ...
    async def copy_image_store_content(
        self,
    ...
    async def delete_image_store_upload_session(
        self,
        session_id: str,
        timeout: Optional[int] = 60,
        **kwargs
    ...
    async def commit_image_store_upload_session(
        self,
        session_id: str,
        timeout: Optional[int] = 60,
        **kwargs
    ...
    async def start_partition_restart(
        self,
        service_id: str,
        partition_id: str,
        operation_id: str,
    ...
    async def start_node_transition(
        self,
        node_name: str,
        operation_id: str,
    ...
    async def enable_application_backup(
        self,
        application_id: str,
        backup_policy_name: str,
        timeout: Optional[int] = 60,
    ...
    async def disable_application_backup(
        self,
        application_id: str,
        clean_backup: bool,
        timeout: Optional[int] = 60,
    ...
    async def suspend_application_backup(
        self,
        application_id: str,
        timeout: Optional[int] = 60,
        **kwargs
    ...
    async def resume_application_backup(
        self,
        application_id: str,
        timeout: Optional[int] = 60,
        **kwargs
    ...
    async def enable_service_backup(
        self,
        service_id: str,
        backup_policy_name: str,
        timeout: Optional[int] = 60,
    ...
    async def disable_service_backup(
        self,
        service_id: str,
        clean_backup: bool,
        timeout: Optional[int] = 60,
    ...
    async def suspend_service_backup(
        self,
        service_id: str,
        timeout: Optional[int] = 60,
        **kwargs
    ...
    async def resume_service_backup(
        self,
        service_id: str,
        timeout: Optional[int] = 60,
        **kwargs
    ...
    async def enable_partition_backup(
        self,
        partition_id: str,
        backup_policy_name: str,
        timeout: Optional[int] = 60,
    ...
    async def disable_partition_backup(
        self,
        partition_id: str,
        clean_backup: bool,
        timeout: Optional[int] = 60,
    ...
    async def suspend_partition_backup(
        self,
        partition_id: str,
        timeout: Optional[int] = 60,
        **kwargs
    ...
    async def resume_partition_backup(
        self,
        partition_id: str,
        timeout: Optional[int] = 60,
        **kwargs
    ...
    async def get_name_exists_info(
        self,
        name_id: str,
        timeout: Optional[int] = 60,
        **kwargs
