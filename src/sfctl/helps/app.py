    ...
    parameters:
        ...
        - name: --compress
          ...
          long-summary: If there is already a compressed file generated by sfctl, it will
              ...
              is not an application package, or if it is already a compressed application
              package. By default, the newly created compressed application package will be deleted
